...
<html lang="es">
	...
	<body>
		...
		<section>
		 <form method="post" class="form" action="peliculas_reporte.php">
			...
			<table class="table">
				...
				<tr>
                    ...
                    <th>Repetida</th>
                    <th>tapa</th>
                    <th> <a href="peli1_new.php"> <button type="button" class="btn btn-info">Nuevo</button> </a> </th>
				</tr>
				...
				while ($registroPeliculas = $resPeliculas->fetch_array(MYSQLI_BOTH))
				{
					...
					echo'<tr>
						        ...
						        <td>'; echo "<a href='peli1_modif.php?id=".$registroPeliculas['id']."'> <button type='button' class='btn btn-success'>Modificar</button> </a>"; echo '</td>
						        
						        
						       <td>'; echo "<a href='pelicula_elim.php?id=".$registroPeliculas['id']."'> <button type='button' class='btn btn-danger'>Eliminar</button> </a>"; echo '</td>
