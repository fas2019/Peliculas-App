...
<![endif]-->
	...
	<head>
		<title>Nuevo Registro FAS MOVIES</title>
		<meta charset="utf-8">
...
<div class="todo">
  ...
  <div id="contenido">
  	<div style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px;">
  		...
  		<br>
	  <form action="peli2_new.php" method="POST" style="border-collapse: separate; border-spacing: 10px 5px;">
		...
		<label>La tengo repetida: </label>
  		...
  		<a href="pelicula_form.html"> <button type='button' class='btn btn-danger'>Subir Imagen</button>
     </form>
     <form>
         <a href="peliculas_app.php"> <button type='button' class='btn btn-primary'>Volver Listado</button>
